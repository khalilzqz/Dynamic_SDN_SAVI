...
public class OFSwitch implements IOFSwitchBackend {
	...
	public void processOFFlow(List<OFFlowStatsReply> replies) {
		System.out.println("processOFFlow.................." + replies);
	}
	
	public void processOFPortStats(List<OFPortStatsReply> replies) {
		System.out.println("processOFPort......................" + replies);
	}
	...
	//	System.out.println("看看。。。" + connections);
				...
				public void run() {
					try {
						...
						if(!replies.isEmpty()) {
							...
							case PORT:
								processOFPortStats((List<OFPortStatsReply>) future.get());
						//		processOFFlow((List<OFFlowStatsReply>) future.get());
								break;
							default:
								throw new Exception("Received an invalid OFStatsReply of " 
										+ replies.get(0).getStatsType().toString() + ". Expected PORT.");
							}
						}
					}
					catch (Exception e) {
				...
				public void run() {
					try {
						...
						if(!replies.isEmpty()) {
							...
							default:
								throw new Exception("Received an invalid OFStatsReply of " 
										+ replies.get(0).getStatsType().toString() + ". Expected FLOW.");
							}
						}
					}
					catch (Exception e) {
